            ...
            <div class="col-md-3">
                <div class="list-group">
                    ...
                    <a href="${pageContext.request.contextPath}/layout-form.html"
                       class="list-group-item text-center active">新增人员</a>
                </div>
            </div>
            <!-- 右侧内容 -->
            <div class="col-md-9">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">新增人员信息</div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <label class="radio-inline">
                                        <input type="radio" name="type" value="0">男
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="type" value="1">女
                                    </label>
                                    <label class="radio-inline">
